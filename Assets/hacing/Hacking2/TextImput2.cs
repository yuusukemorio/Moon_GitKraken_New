...
public class TextImput2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (pattern == "1" && ImputCode == "ddl")
            {
                umakuittaka();
                DebugConsoleERROR = "CONNECTION SUCCESS";

                pattern = "2";
            }
            else if (pattern == "2" && ImputCode == "c bullaeqp ns")
            {
                umakuittaka();
                DebugConsoleERROR = "DISCOVERY";
                pattern = "3";
            }

            else if (pattern == "3" && ImputCode == "pln mmsa")
            {
                umakuittaka();
